# Specification: Claude Code–Only Bootstrap
...
This template is a Claude Code–only project bootstrap. It contains no Antigravity or second-agent scaffolding. A developer cloning this template encounters only Claude Code–specific files and configuration.
